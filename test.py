...
def test_epoch(test_loader,model,criterion,logger,path):
    ...
    log_info=f'seed=40 val loss={np.mean(loss_list):.4f}  {log_info}'
    print(log_info)
...
def test(args):
    ...
    # test_epoch(test_loader,model,criterion,logger,os.path.join(os.getcwd(),'Test1',args.datasets))
    test_epoch(test_loader,model,criterion,logger,os.path.join(os.getcwd(),f'Test',args.datasets))
